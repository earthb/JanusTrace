...
3. Download the Windows installer file (it will have a name like `JanusTrace-Setup.exe`).
...
7. When installation finishes, click 'Finish' to close the installer.

8. You can now find JanusTrace in your Start menu or on your desktop shortcut.

---

## 🖥️ Running JanusTrace for the First Time
...
## 🔧 Using JanusTrace for Requirement Traceability
...
## ⚙️ Configuring JanusTrace Settings
